...
# instance fields
.field private a:Lnet/hockeyapp/android/views/k;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {v6, v0}, Lnet/hockeyapp/android/views/k;->a(Landroid/content/ContentResolver;Landroid/net/Uri;)I
    ...
    .line 64
    :cond_1
    new-instance v1, Lnet/hockeyapp/android/views/k;

    invoke-direct {v1, p0, v0, v4, v5}, Lnet/hockeyapp/android/views/k;-><init>(Landroid/content/Context;Landroid/net/Uri;II)V

    iput-object v1, p0, Lnet/hockeyapp/android/PaintActivity;->a:Lnet/hockeyapp/android/views/k;
    ...
    .line 79
    iget-object v2, p0, Lnet/hockeyapp/android/PaintActivity;->a:Lnet/hockeyapp/android/views/k;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 124
    iget-object v0, p0, Lnet/hockeyapp/android/PaintActivity;->a:Lnet/hockeyapp/android/views/k;

    invoke-virtual {v0}, Lnet/hockeyapp/android/views/k;->c()Z
    ...
    invoke-direct {v0, p0}, Lnet/hockeyapp/android/v;-><init>(Lnet/hockeyapp/android/PaintActivity;)V
    ...
    invoke-static {v2}, Lnet/hockeyapp/android/y;->a(I)Ljava/lang/String;
...
.method public onOptionsItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v0, v1}, Lnet/hockeyapp/android/views/k;->setDrawingCacheEnabled(Z)V

    iget-object v0, p0, Lnet/hockeyapp/android/PaintActivity;->a:Lnet/hockeyapp/android/views/k;

    invoke-virtual {v0}, Lnet/hockeyapp/android/views/k;->getDrawingCache()Landroid/graphics/Bitmap;

    move-result-object v0

    new-instance v3, Lnet/hockeyapp/android/w;

    invoke-direct {v3, p0, v0}, Lnet/hockeyapp/android/w;-><init>(Lnet/hockeyapp/android/PaintActivity;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v3, v0}, Lnet/hockeyapp/android/w;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    invoke-virtual {v0}, Lnet/hockeyapp/android/views/k;->b()V
    ...
    invoke-virtual {v0}, Lnet/hockeyapp/android/views/k;->a()V
